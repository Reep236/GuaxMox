...
public class JacksonLDAPConfiguration implements LDAPConfiguration {
    ...
    /**
     * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_PROXMOX_HOSTNAME}. If
     * not set within the YAML, this will be null.
     */
    @JsonProperty("proxmox-hostname")
    private String proxmoxHostname;

    /**
     * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_PROXMOX_PORT}. If not
     * set within the YAML, this will be null.
     */
    @JsonProperty("proxmox-port")
    private Integer proxmoxPort;
    /**
    ...
    /**
     * The raw YAML value of {@link LDAPGuacamoleProperties#LDAP_PROXMOX_PASSWORD}.
     * If not set within the YAML, this will be null.
     */
    @JsonProperty("proxmox-password")
    ...
    @Override
    public String getProxmoxHostname() throws GuacamoleException {
        return withDefault(proxmoxHostname, defaultConfig::getProxmoxHostname);
    }

    @Override
    public int getProxmoxPort() throws GuacamoleException {
        return withDefault(proxmoxPort, defaultConfig::getProxmoxPort);
    }
    ...
    @Override
    public String getProxmoxPassword() throws GuacamoleException {
        return withDefault(proxmoxPassword, defaultConfig::getProxmoxPassword);
    }
