...
public class LDAPGuacamoleProperties {
    ...
    /**
     * The hostname of the Proxmox server to connect to when retrieving connections
     */
    public static final StringGuacamoleProperty LDAP_PROXMOX_HOSTNAME =
            new StringGuacamoleProperty() {

        @Override
        public String getName() { return "ldap-proxmox-hostname"; }

    };

    /**
     * The port on the Proxmox server to connect to when retrieving connections
     */
    public static final IntegerGuacamoleProperty LDAP_PROXMOX_PORT =
            new IntegerGuacamoleProperty() {

        @Override
        public String getName() { return "ldap-proxmox-port"; }
    ...
    /**
     * The password to provide to the Proxmox server when binding as
     * root@pam.
     */
    public static final StringGuacamoleProperty LDAP_PROXMOX_PASSWORD =
            new StringGuacamoleProperty() {

        @Override
        public String getName() { return "ldap-proxmox-password"; }
