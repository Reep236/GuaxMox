...
public class EnvironmentLDAPConfiguration implements LDAPConfiguration {
    ...
    public String getProxmoxHostname() throws GuacamoleException {
        return environment.getProperty(
            LDAPGuacamoleProperties.LDAP_PROXMOX_HOSTNAME,
            DEFAULT.getProxmoxHostname()
        );
    }
    ...
    public int getProxmoxPort() throws GuacamoleException {
        return environment.getProperty(
            LDAPGuacamoleProperties.LDAP_PROXMOX_PORT,
            DEFAULT.getProxmoxPort()
        );
    }
    ...
    public String getProxmoxPassword() throws GuacamoleException {
        return environment.getProperty(
            LDAPGuacamoleProperties.LDAP_PROXMOX_PASSWORD,
            DEFAULT.getProxmoxPassword()
        );
    }
