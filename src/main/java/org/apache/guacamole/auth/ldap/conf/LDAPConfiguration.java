...
public interface LDAPConfiguration {
    ...
    /**
     * Returns the hostname or IP address of the Proxmox server.
     *
     * @return
     *     The hostname or IP address of the Proxmox server.
     *
     * @throws GuacamoleException
     *     If the hostname or IP address of the Proxmox server cannot be
     *     retrieved.
     */
    String getProxmoxHostname() throws GuacamoleException;
    ...
    /**
     * Returns the port of the Proxmox server. The default value is 8006
     *
     * @return
     *     The port of the Proxmox server.
     *
     * @throws GuacamoleException
     *     If the port of the Proxmox server cannot be retrieved.
     */
    int getProxmoxPort() throws GuacamoleException;
    ...
    /**
     * Returns the password that should be used when binding to Proxmox
     * using root@pam (restricted due to privileged calls). If no password should be
     * used, null is returned.
     *
     * @return
     *     The password that should be used when binding to Proxmox
     *     using root@pam (restricted due to privileged calls), or null if no password
     *     should be used.
     *
     * @throws GuacamoleException
     *     If the proxmox password cannot be retrieved.
     */
    String getProxmoxPassword() throws GuacamoleException;
